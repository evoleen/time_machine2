...
ZoneRecurrence Winter = ZoneRecurrence(
    'Winter',
    Offset.zero,
...
ZoneRecurrence Summer = ZoneRecurrence(
    'Summer',
    Offset.hours(1),
...
DateTimeZone TestZone = PrecalculatedDateTimeZone(
    'zone',
    [
      IZoneInterval.newZoneInterval('Before', IInstant.beforeMinValue,
          Instant.utc(1999, 12, 1, 0, 0), Offset.hours(5), Summer.savings)
    ],
    StandardDaylightAlternatingMap(Offset.hours(5), Winter, Summer));
...
void Equality() {
  ...
  var map3 = StandardDaylightAlternatingMap(
      Offset.hours(1),
      Winter,
      ...
      ZoneRecurrence(
          ...
          Offset.hours(1),
          ZoneYearOffset(
              TransitionMode.wall, 3, 10, 0, false, LocalTime(1, 0, 0)),
          1900,
          Platform.int32MaxValue));
  ...
  var unequalMaps = [
    ...
    ZoneRecurrence(
        ...
        Offset.hours(1),
        ZoneYearOffset(
            TransitionMode.standard, 3, 10, 0, false, LocalTime(1, 0, 0)),
        2000,
        Platform.int32MaxValue),
    ZoneRecurrence(
        'Summer',
        Offset.hours(1),
        ZoneYearOffset(
            TransitionMode.wall, 4, 10, 0, false, LocalTime(1, 0, 0)),
        2000,
        Platform.int32MaxValue),
    ZoneRecurrence(
        'Summer',
        Offset.hours(1),
        ZoneYearOffset(TransitionMode.wall, 3, 9, 0, false, LocalTime(1, 0, 0)),
        2000,
        Platform.int32MaxValue),
    ZoneRecurrence(
        'Summer',
        Offset.hours(1),
        ZoneYearOffset(
            TransitionMode.wall, 3, 10, 1, false, LocalTime(1, 0, 0)),
        2000,
        Platform.int32MaxValue),
    ...
    ZoneRecurrence(
        'Summer',
        Offset.hours(1),
        ZoneYearOffset(TransitionMode.wall, 3, 10, 0, true, LocalTime(1, 0, 0)),
        2000,
        Platform.int32MaxValue),
    ZoneRecurrence(
        'Summer',
        Offset.hours(1),
        ZoneYearOffset(
            TransitionMode.wall, 3, 10, 0, false, LocalTime(2, 0, 0)),
        2000,
        Platform.int32MaxValue)
  ]
      .map((recurrence) =>
          StandardDaylightAlternatingMap(Offset.hours(1), Winter, recurrence))
      .toList();
...
void Extremes() {
  ...
  var firstWinter = IZoneInterval.newZoneInterval(
      'Winter', IInstant.beforeMinValue, firstSpring, Offset.zero, Offset.zero);
  var firstSummer = IZoneInterval.newZoneInterval(
      'Summer', firstSpring, firstAutumn, dstOffset, dstOffset);
  var lastSummer = IZoneInterval.newZoneInterval(
      'Summer', lastSpring, lastAutumn, dstOffset, dstOffset);
  var lastWinter = IZoneInterval.newZoneInterval(
      'Winter', lastAutumn, IInstant.afterMaxValue, Offset.zero, Offset.zero);
...
void InvalidMap_SimultaneousTransition() {
  ...
  ZoneRecurrence r1 = ZoneRecurrence(
      'Recurrence1',
      Offset.zero,
      ZoneYearOffset(TransitionMode.utc, 10, 5, 0, false, LocalTime(2, 0, 0)),
      Platform.int32MinValue,
      Platform.int32MaxValue);

  ZoneRecurrence r2 = ZoneRecurrence(
      'Recurrence2',
      Offset.hours(1),
      ZoneYearOffset(TransitionMode.utc, 10, 5, 0, false, LocalTime(2, 0, 0)),
      Platform.int32MinValue,
  ...
  expect(() => map.getZoneInterval(Instant.utc(2017, 8, 25, 0, 0, 0)),
      throwsStateError);
}

void CheckMapping(ZoneLocalMapping mapping, String earlyIntervalName,
    String lateIntervalName, int count) {
