...
import 'test_helper_interface.dart'
    ...
    if (dart.library.io) 'test_helper_with_mirrors.dart' as helping_machine;

late Function<T>(T value, T equalValue, T unequalValue)
    testOperatorEqualityFunction;
late Function<T>(T value, T equalValue, List<T> greaterValues)
...
abstract class TestHelper {
  ...
  static void TestOperatorComparisonEquality<T>(
          T value, T equalValue, List<T> greaterValues) =>
      testOperatorComparisonEqualityFunction;
  ...
  /// [equalValue]: The value equal to but not the same object as the base value.
  /// [greaterValue]: The values greater than the base value, in ascending order.
  static void TestOperatorComparison<T>(
          T value, T equalValue, List<T> greaterValues) =>
      testOperatorComparisonFunction;
  ...
  static void AssertInvalid2<TArg1, TArg2, TOut>(
      TOut Function(TArg1, TArg2) func, TArg1 arg1, TArg2 arg2) {
  ...
  static void AssertArgumentNull<TArg, TOut>(
      TOut Function(TArg) func, TArg arg) {
    expect(() => func(arg), throwsArgumentError);
  ...
  static void AssertOutOfRange2<TArg1, TArg2, TOut>(
      TOut Function(TArg1, TArg2) func, TArg1 arg1, TArg2 arg2) {
  ...
  static void AssertArgumentNull2<TArg1, TArg2, TOut>(
      TOut Function(TArg1, TArg2) func, TArg1 arg1, TArg2 arg2) {
  ...
  static void AssertValid2<TArg1, TArg2, TOut>(
      TOut Function(TArg1, TArg2) func, TArg1 arg1, TArg2 arg2) {
    func(arg1, arg2);
  }

  /// Asserts that calling the specified delegate with the specified values throws ArgumentOutOfRangeException.
  static void AssertOutOfRange3<TArg1, TArg2, TArg3, TOut>(
      TOut Function(TArg1, TArg2, TArg3) func,
      TArg1 arg1,
      TArg2 arg2,
      TArg3 arg3) {
  ...
  /// Asserts that calling the specified delegate with the specified values throws ArgumentNullException.
  static void AssertArgumentNull3<TArg1, TArg2, TArg3, TOut>(
      TOut Function(TArg1, TArg2, TArg3) func,
      TArg1 arg1,
      TArg2 arg2,
      TArg3 arg3) {
    // Assert.Throws<ArgumentNullException>(() => func(arg1, arg2, arg3));
    expect(() => func(arg1, arg2, arg3), throwsA(isA<TypeError>()));
  }

  /// Asserts that calling the specified delegate with the specified values doesn't throw an exception.
  static void AssertValid3<TArg1, TArg2, TArg3, TOut>(
      TOut Function(TArg1, TArg2, TArg3) func,
      TArg1 arg1,
      TArg2 arg2,
      TArg3 arg3) {
  ...
  static void AssertOverflow<TArg1, TOut>(
      TOut Function(TArg1) func, TArg1 arg1) {
  ...
  static void AssertNoFailures<T>(
      Iterable<T> failures, String Function(T) failureFormatter) {
...
//  }
  ...
  static void TestComparerStruct<T>(
      Comparator<T> comparer, T value, T equalValue, T greaterValue) {
  ...
  /// [equalValue]: The value equal to but not the same object as the base value.
  /// [greaterValue]: The values greater than the base value, in ascending order.
  static void TestCompareToClass<T extends Comparable<T?>>(
      T value, T equalValue, List<T> greaterValues) {
    ValidateInput(value, equalValue, greaterValues, 'greaterValue');
    expect(value.compareTo(null) > 0, isTrue,
        reason: 'value.CompareTo<T>(null)');
    expect(value.compareTo(value) == 0, isTrue,
        reason: 'value.CompareTo<T>(value)');
    expect(value.compareTo(equalValue) == 0, isTrue,
        reason: 'value.CompareTo<T>(equalValue)');
    expect(equalValue.compareTo(value) == 0, isTrue,
        reason: 'equalValue.CompareTo<T>(value)');
    for (var greaterValue in greaterValues) {
      expect(value.compareTo(greaterValue) < 0, isTrue,
          reason: 'value.CompareTo<T>(greaterValue)');
      expect(greaterValue.compareTo(value) > 0, isTrue,
          reason: 'greaterValue.CompareTo<T>(value)');
  ...
  /// [equalValue]: The value equal to but not the same object as the base value.
  /// [greaterValue]: The values greater than the base value, in ascending order.
  static void TestCompareToStruct<T extends Comparable<T>>(T value,
      T equalValue, List<T> greaterValues) // where T : struct, IComparable<T>
  {
...
//  }
  ...
  static void TestEqualsClass<T>(T value, T equalValue,
      List<T> unequalValues) // where T : class, IEquatable<T>
  {
    ...
    expect(value == (equalValue), isTrue,
        reason: 'value.Equals<T>(equalValue)');
    expect(equalValue == (value), isTrue,
        reason: 'equalValue.Equals<T>(value)');
    for (var unequal in unequalValues) {
      expect(value == (unequal), isFalse,
          reason: 'value.Equals<T>(unequalValue)');
    }
  }
  ...
  /// [equalValue]: The value equal to but not the same object as the base value.
  /// [unequalValue]: The value not equal to the base value.
  static void TestEqualsStruct<T>(T value, T equalValue,
      Iterable<T> unequalValues) // where T : struct, IEquatable<T>
  {
  ...
  static void TestObjectEquals(
      dynamic value, dynamic equalValue, List<dynamic> unequalValues) {
    ...
    for (var unequalValue in unequalValues) {
      expect(value == (unequalValue), isFalse,
          reason: 'value.Equals(unequalValue)');
    }
    expect(value.hashCode, value.hashCode,
        reason: 'hashCode twice for same object');
    expect(value.hashCode, equalValue.hashCode,
        reason: 'hashCode for two different but equal objects');
  }
  ...
  static void ValidateInput(Object? value, dynamic equalValue,
      List unequalValues, String unequalName) {
    ...
    expect(value, isNotNull,
        reason: 'value cannot be null in TestObjectEquals() method');
    expect(equalValue, isNotNull,
        reason: 'equalValue cannot be null in TestObjectEquals() method');
    expect(identical(equalValue, value), isFalse,
        reason: 'value and equalValue MUST be different objects');

    for (var unequalValue in unequalValues) {
      expect(unequalName, isNotNull,
          reason: unequalName + ' cannot be null in TestObjectEquals() method');
      expect(identical(value, unequalValue), isFalse,
          reason: unequalName + ' and value MUST be different objects');
  ...
  /// [unequalValue]: The value not equal to the base value.
  /// [unequalName]: The name to use in 'not equal value' error messages.
  static void ValidateInput_Single(Object value, Object equalValue,
      Object unequalValue, String unequalName) {
