...
class ZoneTransition {
  ...
  bool isTransitionFrom(ZoneTransition? other) {
    ...
    bool different = name != other.name ||
  ...
  ZoneInterval toZoneInterval(Instant end) => IZoneInterval.newZoneInterval(
      name, instant, end, standardOffset + savings, savings);
...
// #region Object overrides
  ...
  /// </returns>
  @override
  String toString() => '$name at $instant $standardOffset [$savings]';
