...
class ZoneRuleSet {
  ...
  ZoneRuleSet.rules(
      this._rules, this.standardOffset, this._upperYear, this._upperYearOffset)
      : _name = null,
        _fixedSavings = Offset.zero;

  ZoneRuleSet.named(this._name, this.standardOffset, this._fixedSavings,
      this._upperYear, this._upperYearOffset)
      : _rules = [];
  ...
  ZoneInterval CreateFixedInterval(Instant start) {
    ...
    return IZoneInterval.newZoneInterval(
        _name!, start, limit, standardOffset + _fixedSavings, _fixedSavings);
  }
