...
class PeriodUnits {
  ...
  static const PeriodUnits hourMinuteSecond =
      PeriodUnits(112); // union(const [hours, minutes, seconds]);
  /// Compound value representing the combination of all time elements
  static const PeriodUnits allTimeUnits = PeriodUnits(
  ...
  static const PeriodUnits dateAndTime = PeriodUnits(
  ...
  static const PeriodUnits allUnits = PeriodUnits(
