...
class PatternFields {
  ...
  static const PatternFields yearTwoDigits =
      PatternFields(1 << 8); // Actually year of *era* as two digits...
  ...
  static const PatternFields totalTime =
      PatternFields(1 << 19); // D, H, M, or S in a DurationPattern.
  static const PatternFields embeddedDate = PatternFields(1 <<
      20); // No other date fields permitted, use calendar/year/month/day from bucket
  static const PatternFields embeddedTime = PatternFields(1 <<
