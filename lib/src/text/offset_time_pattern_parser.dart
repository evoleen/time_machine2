...
class OffsetTimePatternParser implements IPatternParser<OffsetTime> {
  ...
  static final Map<String /*char*/,
          CharacterHandler<OffsetTime, _OffsetTimeParseBucket>>
      _patternCharacterHandlers = {
    '%': SteppedPatternBuilder
        .handlePercent /**<OffsetTime, OffsetTimeParseBucket>*/,
    '\'': SteppedPatternBuilder
        .handleQuote /**<OffsetTime, OffsetTimeParseBucket>*/,
    '\"': SteppedPatternBuilder
        .handleQuote /**<OffsetTime, OffsetTimeParseBucket>*/,
    '\\': SteppedPatternBuilder
        .handleBackslash /**<OffsetTime, OffsetTimeParseBucket>*/,
    '.': TimePatternHelper.createPeriodHandler<OffsetTime,
            _OffsetTimeParseBucket>(9, (value) => value.nanosecondOfSecond,
        (bucket, value) => bucket.time.fractionalSeconds = value),
    ';': TimePatternHelper.createCommaDotHandler<OffsetTime,
            _OffsetTimeParseBucket>(9, (value) => value.nanosecondOfSecond,
        (bucket, value) => bucket.time.fractionalSeconds = value),
    ':': (pattern, builder) => builder.addLiteral1(
        builder.formatInfo.timeSeparator,
        IParseResult.timeSeparatorMismatch /**<OffsetTime>*/),
    'h': SteppedPatternBuilder.handlePaddedField<OffsetTime,
            _OffsetTimeParseBucket>(
        2,
    ...
    'm': SteppedPatternBuilder.handlePaddedField<OffsetTime,
            _OffsetTimeParseBucket>(
        2,
    ...
    's': SteppedPatternBuilder.handlePaddedField<OffsetTime,
            _OffsetTimeParseBucket>(
        2,
    ...
    'f': TimePatternHelper.createFractionHandler<OffsetTime,
            _OffsetTimeParseBucket>(9, (value) => value.nanosecondOfSecond,
        (bucket, value) => bucket.time.fractionalSeconds = value),
    'F': TimePatternHelper.createFractionHandler<OffsetTime,
            _OffsetTimeParseBucket>(9, (value) => value.nanosecondOfSecond,
        (bucket, value) => bucket.time.fractionalSeconds = value),
    't':
        TimePatternHelper.createAmPmHandler<OffsetTime, _OffsetTimeParseBucket>(
            (time) => time.hourOfDay,
            (bucket, value) => bucket.time.amPm = value),
    'o': _handleOffset,
    'l': (cursor, builder) => builder.addEmbeddedTimePattern(
        cursor.current,
        cursor.getEmbeddedPattern(),
        (bucket) => bucket.time,
  ...
  @override
  IPattern<OffsetTime> parsePattern(
      ...
      switch (patternText[0]) {
        ...
        default:
          throw IInvalidPatternError.format(
              ...
              [patternText[0], 'OffsetTime']);
      }
    }

    var patternBuilder =
        SteppedPatternBuilder<OffsetTime, _OffsetTimeParseBucket>(
            formatInfo, () => _OffsetTimeParseBucket(_templateValue));
...
class _OffsetTimeParseBucket extends ParseBucket<OffsetTime> {
  ...
  @override
  ParseResult<OffsetTime> calculateValue(
      PatternFields usedFields, String text) {
    ParseResult<LocalTime> timeResult =
        time.calculateValue(usedFields & PatternFields.allTimeFields, text);
