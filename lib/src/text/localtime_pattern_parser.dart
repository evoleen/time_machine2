...
class LocalTimePatternParser implements IPatternParser<LocalTime> {
  ...
  static final Map<String /*char*/,
          CharacterHandler<LocalTime, LocalTimeParseBucket>>
      _patternCharacterHandlers = {
    '%': SteppedPatternBuilder
        .handlePercent /**<LocalTime, LocalTimeParseBucket>*/,
    '\'': SteppedPatternBuilder
        .handleQuote /**<LocalTime, LocalTimeParseBucket>*/,
    '\"': SteppedPatternBuilder
        .handleQuote /**<LocalTime, LocalTimeParseBucket>*/,
    '\\': SteppedPatternBuilder
        .handleBackslash /**<LocalTime, LocalTimeParseBucket>*/,
    '.': TimePatternHelper.createPeriodHandler<LocalTime, LocalTimeParseBucket>(
        9,
        (value) => value.nanosecondOfSecond,
        (bucket, value) => bucket.fractionalSeconds = value),
    ';': TimePatternHelper.createCommaDotHandler<LocalTime,
            LocalTimeParseBucket>(9, (value) => value.nanosecondOfSecond,
        (bucket, value) => bucket.fractionalSeconds = value),
    ':': (pattern, builder) => builder.addLiteral1(
        builder.formatInfo.timeSeparator,
        IParseResult.timeSeparatorMismatch /**<LocalTime>*/),
    'h': SteppedPatternBuilder
        .handlePaddedField /**<LocalTime, LocalTimeParseBucket>*/ (
            2,
            PatternFields.hours12,
            1,
            12,
            (value) => value.hourOf12HourClock,
            (bucket, value) => bucket.hours12 = value),
    'H': SteppedPatternBuilder
        .handlePaddedField /**<LocalTime, LocalTimeParseBucket>*/ (
            2,
            ...
            (bucket, value) => bucket.hours24 = value),
    'm': SteppedPatternBuilder
        .handlePaddedField /**<LocalTime, LocalTimeParseBucket>*/ (
            2,
    ...
    'f': TimePatternHelper.createFractionHandler<LocalTime,
            LocalTimeParseBucket>(9, (value) => value.nanosecondOfSecond,
        (bucket, value) => bucket.fractionalSeconds = value),
    'F': TimePatternHelper.createFractionHandler<LocalTime,
            LocalTimeParseBucket>(9, (value) => value.nanosecondOfSecond,
        (bucket, value) => bucket.fractionalSeconds = value),
    't': TimePatternHelper.createAmPmHandler<LocalTime, LocalTimeParseBucket>(
        (time) => time.hourOfDay, (bucket, value) => bucket.amPm = value)
  };
  ...
  @override
  IPattern<LocalTime> parsePattern(
    ...
    if (patternText.length == 1) {
      ...
      if (expandedPatternText == null) {
        throw IInvalidPatternError.format(
            ...
            [patternCharacter, 'LocalTime']);
      }
      patternText = expandedPatternText;
    }

    var patternBuilder = SteppedPatternBuilder<LocalTime, LocalTimeParseBucket>(
        formatInfo, () => LocalTimeParseBucket(_templateValue));
  ...
  String? _expandStandardFormatPattern(
      String /*char*/ patternCharacter, TimeMachineFormatInfo formatInfo) {
...
class LocalTimeParseBucket extends ParseBucket<LocalTime> {
  ...
  ParseResult<LocalTime> calculateValue(PatternFields usedFields, String text) {
    if (usedFields.hasAny(PatternFields.embeddedTime)) {
      return ParseResult.forValue<LocalTime>(
          LocalTime(hours24, minutes, seconds, ns: fractionalSeconds));
    }
    if (amPm == 2) {
    ...
    int _minutes = usedFields.hasAny(PatternFields.minutes)
        ? minutes
        : templateValue.minuteOfHour;
    int _seconds = usedFields.hasAny(PatternFields.seconds)
        ? seconds
        : templateValue.secondOfMinute;
    int _nanoseconds = usedFields.hasAny(PatternFields.fractionalSeconds)
        ? fractionalSeconds
        : templateValue.nanosecondOfSecond;
    return ParseResult.forValue<LocalTime>(
        LocalTime(hour, _minutes, _seconds, ns: _nanoseconds));
  }

  //static const PatternFields hours12 = const PatternFields(1 << 1);
  //static const PatternFields amPm = const PatternFields(1 << 6);
  static const PatternFields _hours12_booleanOR_amPm =
      PatternFields(1 << 1 | 1 << 6);
    ...
    if (usedFields.hasAny(PatternFields.hours24)) {
      if (usedFields.hasAll(PatternFields.hours12 | PatternFields.hours24)) {
        if (hours12 % 12 != hours24 % 12) {
          return IParseResult.inconsistentValues<int>(
              text, 'H', 'h', 'LocalTime');
        }
      }
