...
import 'package:time_machine2/src/utility/time_machine_utilities.dart';
...
class InvalidPatternError extends Error // FormatException
{
  ...
  @override
  String toString() => 'InvalidPatternError: $message';
}

abstract class IInvalidPatternError {
  static InvalidPatternError format(
          String formatString, List<dynamic> parameters) =>
      InvalidPatternError._format(formatString, parameters);
}
