...
class OffsetDatePatternParser implements IPatternParser<OffsetDate> {
  ...
  static final Map<String /*char*/,
          CharacterHandler<OffsetDate, _OffsetDateParseBucket>>
      _patternCharacterHandlers = {
    '%': SteppedPatternBuilder
        .handlePercent /**<OffsetDate, OffsetDateParseBucket>*/,
    '\'': SteppedPatternBuilder
        .handleQuote /**<OffsetDate, OffsetDateParseBucket>*/,
    '\"': SteppedPatternBuilder
        .handleQuote /**<OffsetDate, OffsetDateParseBucket>*/,
    '\\': SteppedPatternBuilder
        .handleBackslash /**<OffsetDate, OffsetDateParseBucket>*/,
    '/': (pattern, builder) => builder.addLiteral1(
        builder.formatInfo.dateSeparator,
        IParseResult.dateSeparatorMismatch /**<OffsetDate>*/),
    'y': DatePatternHelper.createYearOfEraHandler<OffsetDate,
            _OffsetDateParseBucket>((value) => value.yearOfEra,
        (bucket, value) => bucket.date.yearOfEra = value),
    'u': SteppedPatternBuilder.handlePaddedField<OffsetDate,
            _OffsetDateParseBucket>(4, PatternFields.year, -9999, 9999,
        (value) => value.year, (bucket, value) => bucket.date.year = value),
    'M': DatePatternHelper.createMonthOfYearHandler<OffsetDate,
            _OffsetDateParseBucket>(
    ...
    'c': DatePatternHelper.createCalendarHandler<OffsetDate,
            _OffsetDateParseBucket>((value) => value.calendarDate.calendar,
        (bucket, value) => bucket.date.calendar = value),
    'g': DatePatternHelper.createEraHandler<OffsetDate, _OffsetDateParseBucket>(
        (value) => value.era, (bucket) => bucket.date),
    'o': _handleOffset,
    'l': (cursor, builder) => builder.addEmbeddedDatePattern(
        cursor.current,
  ...
  @override
  IPattern<OffsetDate> parsePattern(
      ...
      switch (patternText[0]) {
        ...
        default:
          throw IInvalidPatternError.format(
              ...
              [patternText[0], 'OffsetDate']);
      }
    }

    var patternBuilder =
        SteppedPatternBuilder<OffsetDate, _OffsetDateParseBucket>(
            formatInfo, () => _OffsetDateParseBucket(_templateValue));
...
class _OffsetDateParseBucket extends ParseBucket<OffsetDate> {
  ...
  @override
  ParseResult<OffsetDate> calculateValue(
      PatternFields usedFields, String text) {
    ParseResult<LocalDate> dateResult =
        date.calculateValue(usedFields & PatternFields.allDateFields, text);
