...
class OffsetDateTimePatternParser implements IPatternParser<OffsetDateTime> {
  ...
  static final Map<String /*char*/,
          CharacterHandler<OffsetDateTime, _OffsetDateTimeParseBucket>>
    ...
    '%': SteppedPatternBuilder
        .handlePercent /**<OffsetDateTime, OffsetDateTimeParseBucket>*/,
    '\'': SteppedPatternBuilder
        .handleQuote /**<OffsetDateTime, OffsetDateTimeParseBucket>*/,
    '\"': SteppedPatternBuilder
        .handleQuote /**<OffsetDateTime, OffsetDateTimeParseBucket>*/,
    '\\': SteppedPatternBuilder
        .handleBackslash /**<OffsetDateTime, OffsetDateTimeParseBucket>*/,
    '/': (pattern, builder) => builder.addLiteral1(
        builder.formatInfo.dateSeparator,
        IParseResult.dateSeparatorMismatch /**<OffsetDateTime>*/),
    'T': (pattern, builder) => builder.addLiteral2(
        'T', IParseResult.mismatchedCharacter /**<OffsetDateTime>*/),
    'y': DatePatternHelper.createYearOfEraHandler<OffsetDateTime,
            _OffsetDateTimeParseBucket>((value) => value.yearOfEra,
        (bucket, value) => bucket.date.yearOfEra = value),
    'u': SteppedPatternBuilder.handlePaddedField<OffsetDateTime,
            _OffsetDateTimeParseBucket>(4, PatternFields.year, -9999, 9999,
        (value) => value.year, (bucket, value) => bucket.date.year = value),
    'M': DatePatternHelper.createMonthOfYearHandler<OffsetDateTime,
            _OffsetDateTimeParseBucket>(
        (value) => value.monthOfYear,
        (bucket, value) => bucket.date.monthOfYearText = value,
        (bucket, value) => bucket.date.monthOfYearNumeric = value),
    'd': DatePatternHelper.createDayHandler<OffsetDateTime,
            _OffsetDateTimeParseBucket>(
        (value) => value.dayOfMonth,
        (value) => value.dayOfWeek.value,
        (bucket, value) => bucket.date.dayOfMonth = value,
        (bucket, value) => bucket.date.dayOfWeek = value),
    '.': TimePatternHelper.createPeriodHandler<OffsetDateTime,
            _OffsetDateTimeParseBucket>(9, (value) => value.nanosecondOfSecond,
        (bucket, value) => bucket.time.fractionalSeconds = value),
    ';': TimePatternHelper.createCommaDotHandler<OffsetDateTime,
            _OffsetDateTimeParseBucket>(9, (value) => value.nanosecondOfSecond,
        (bucket, value) => bucket.time.fractionalSeconds = value),
    ':': (pattern, builder) => builder.addLiteral1(
        builder.formatInfo.timeSeparator,
        IParseResult.timeSeparatorMismatch /**<OffsetDateTime>*/),
    'h': SteppedPatternBuilder.handlePaddedField<OffsetDateTime,
            _OffsetDateTimeParseBucket>(
        2,
    ...
    'm': SteppedPatternBuilder.handlePaddedField<OffsetDateTime,
            _OffsetDateTimeParseBucket>(
        2,
    ...
    's': SteppedPatternBuilder.handlePaddedField<OffsetDateTime,
            _OffsetDateTimeParseBucket>(
        2,
    ...
    'f': TimePatternHelper.createFractionHandler<OffsetDateTime,
            _OffsetDateTimeParseBucket>(9, (value) => value.nanosecondOfSecond,
        (bucket, value) => bucket.time.fractionalSeconds = value),
    'F': TimePatternHelper.createFractionHandler<OffsetDateTime,
            _OffsetDateTimeParseBucket>(9, (value) => value.nanosecondOfSecond,
        (bucket, value) => bucket.time.fractionalSeconds = value),
    't': TimePatternHelper.createAmPmHandler<OffsetDateTime,
            _OffsetDateTimeParseBucket>(
        (time) => time.hourOfDay, (bucket, value) => bucket.time.amPm = value),
    'c': DatePatternHelper.createCalendarHandler<OffsetDateTime,
            _OffsetDateTimeParseBucket>((value) => value.localDateTime.calendar,
        (bucket, value) => bucket.date.calendar = value),
    'g': DatePatternHelper.createEraHandler<OffsetDateTime,
            _OffsetDateTimeParseBucket>(
  ...
  @override
  IPattern<OffsetDateTime> parsePattern(
      ...
      switch (patternText[0]) {
        ...
        default:
          throw IInvalidPatternError.format(
              ...
              [patternText[0], 'OffsetDateTime']);
      }
    }

    var patternBuilder =
        SteppedPatternBuilder<OffsetDateTime, _OffsetDateTimeParseBucket>(
            formatInfo, () => _OffsetDateTimeParseBucket(_templateValue));
...
class _OffsetDateTimeParseBucket extends ParseBucket<OffsetDateTime> {
  ...
  @override
  ParseResult<OffsetDateTime> calculateValue(
    ...
    return ParseResult.forValue<OffsetDateTime>(
        localDateTime.withOffset(offset));
  }
}
