...
abstract class Time implements Comparable<Time> {
  ...
  static const Time oneMicrosecond =
      MillisecondTime(0, TimeConstants.nanosecondsPerMicrosecond);
  static const Time oneMillisecond = MillisecondTime(1, 0);
  static const Time oneSecond =
      MillisecondTime(TimeConstants.millisecondsPerSecond, 0);
  static const Time oneDay =
      MillisecondTime(TimeConstants.millisecondsPerDay, 0);
  static const Time oneWeek =
      MillisecondTime(TimeConstants.millisecondsPerWeek, 0);
  ...
  */
  ...
  @override
  int get hashCode => _milliseconds.hashCode ^ _nanosecondsInterval;
...
class NanosecondTime extends Time {
  ...
  NanosecondTime(this._nanoseconds) : super._() {
    assert(_nanoseconds >= Platform.intMinValue &&
        _nanoseconds <= Platform.intMaxValue);
  }
