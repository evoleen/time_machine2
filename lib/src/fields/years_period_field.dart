...
@internal
class YearsPeriodField implements IDatePeriodField {
  ...
  LocalDate add(LocalDate localDate, int value) {
    ...
    Preconditions.checkArgumentRange('value', value,
        calculator.minYear - currentYear, calculator.maxYear - currentYear);
    return ILocalDate.trusted(calculator
        .setYear(yearMonthDay, currentYear + value)
