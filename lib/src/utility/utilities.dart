...
abstract class Platform {
  ...
  static const int intMinValueJS =
      -9007199254740992; // -math.pow(2, 53); appears to be the same (not 1 more, not 1 less)
  static const int int32MinValue = -2147483648;
  static const int int32MaxValue = 2147483647;

  static const int maxMicrosecondsToNanoseconds =
      Platform.intMaxValueJS ~/ TimeConstants.microsecondsPerMillisecond;
  ...
  static const int valueCursorPrediction =
      13860 * 66546695792603; // vm: 922337203685477580; js: 922337203685477600
  static const int int64MinValue = 2147483648 *
      2147483648 *
      -2; // vm: -9223372036854775808; js: -9223372036854776000
  static const int int64MaxValue = 2147483648 * 2147483648 -
      1 +
      2147483648 *
          2147483648; // vm: 9223372036854775807; js: 9223372036854776000

  static int _intMaxValue =
      isVM ? _intMaxValue = int64MaxValue : _intMaxValue = intMaxValueJS;
  static int _intMinValue =
      isVM ? _intMinValue = int64MinValue : _intMinValue = intMinValueJS;
  static int get intMaxValue => _intMaxValue;
  static int get intMinValue => _intMinValue;

  static BigInt? _bigIntMinValue;
  static BigInt bigIntMinValue =
      _bigIntMinValue ??= BigInt.from(Platform.intMinValue);

  static BigInt? _bigIntMaxValue;
  static BigInt bigIntMaxValue =
