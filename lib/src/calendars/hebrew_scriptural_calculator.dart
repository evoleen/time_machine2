...
abstract class HebrewScripturalCalculator {
  ...
  static final List<YearStartCacheEntry> _yearCache =
  ...
  static YearMonthDay getYearMonthDay(int year, int dayOfYear) {
    ...
    if (dayOfYear < 31 + 29 + 30 + 30 + 29 + 30 + 29 + 30) {
      // Av
      return YearMonthDay(
          year, 5, dayOfYear - (30 + 29 + 30 + 30 + 29 + 30 + 29));
    }
    // Elul
    return YearMonthDay(
        year, 6, dayOfYear - (30 + 29 + 30 + 30 + 29 + 30 + 29 + 30));
  }
  ...
  static int _elapsedDaysNoCache(int year) {
    int monthsElapsed =
        (235 * ((year - 1) ~/ 19)) // Months in complete cycles so far
            ...
            +
            ((arithmeticMod((year - 1), 19) * 7 + 1) ~/
                19); // Leap months this cycle
    ...
    int parts = (arithmeticMod(hoursElapsed, 24) * 1080) +
        arithmeticMod(partsElapsed, 1080);
    ...
    return (alternativeDayMod7 == 0 ||
            alternativeDayMod7 == 3 ||
            alternativeDayMod7 == 5)
        ? alternativeDay + 1
        : alternativeDay;
  }
